...
# 功能1： 头部特效
def function1():
	with open('head1.py', 'r', encoding='GBK') as f:
		exec(f.read())

def function2():
	with open('xxx.py', 'r', encoding='GBK') as f:
		exec(f.read())
...
b2 = tk.Button(frame1, text='功能1', font=ft1, width=10, height=1, relief='solid', command=function1).pack(side=tk.TOP)
b3 = tk.Button(frame1, text='功能2', font=ft1, width=10, height=1, relief='solid', command=function2).pack(side=tk.TOP)
b4 = tk.Button(frame1, text='功能3', font=ft1, width=10, height=1, relief='solid', command=function3).pack(side=tk.TOP)
b5 = tk.Button(frame1, text='功能4', font=ft1, width=10, height=1, relief='solid', command=function4).pack(side=tk.TOP)
