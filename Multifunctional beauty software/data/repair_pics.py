...
'''
#remove_water_mark(local_args.filename, local_args.save_name)
repair_h.remove_water_mark(local_args.filename, local_args.save_name)
image = cv2.imread(local_args.save_name)
